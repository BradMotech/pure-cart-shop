...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-muted/30 backdrop-blur-sm p-1.5 text-muted-foreground border border-border/50 shadow-sm",
      className
    )}
    {...props}
  />
